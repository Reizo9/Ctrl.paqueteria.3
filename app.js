/* app.js final: +Foto Guardia +Comentarios +Opcion Notificar +Historial Cards +COMPRESION + TOAST + RESPALDO + ZXING / BarcodeDetector + QR */
(async function(){
        ...
        try {
          ...
          if (hasBarcodeDetector) {
            ...
            barcodeDetector = new window.BarcodeDetector({
              formats: ['qr_code', 'code_128', 'code_39', 'ean_13'] // <-- CAMBIO: Añadido 'qr_code'
            });
            ...
            // --- INICIO CAMBIO QR ---
            // Crear un "hint" para decirle a ZXing qué formatos buscar
            const hints = new Map();
            const formats = [
